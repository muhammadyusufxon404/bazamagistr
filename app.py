...
#         fani = request.form["fani"]
#         admin = request.form["admin"]
#         bosh_vaqti = request.form["bosh_vaqti"]
#         sinfi = request.form["sinfi"]
...
#                 <th>Sinfi</th><th>Bo'sh vaqti</th><th>Fani</th><th>Admin</th><th>Sana</th><th>Izoh</th><th>Amallar</th>
#             </tr>
#             {% for s in registrations %}
#             <tr>
#                 <td>{{ s[0] }}</td><td>{{ s[1] }}</td><td>{{ s[2] }}</td>
#                 <td>{{ s[3] }}</td><td>{{ s[4] }}</td><td>{{ s[9] }}</td>
#                 <td>{{ s[8] }}</td><td>{{ s[6] }}</td><td>{{ s[7] }}</td>
#                 <td>{{ s[10] }}</td><td>{{ s[5] }}</td>
#                 <td>
