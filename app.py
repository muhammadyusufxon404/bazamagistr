...
@app.route("/")
def home():
    return render_template_string("<h1>Salom! Railway Flask ishlayapti 🚀</h1>")

# favicon qo'shish (ixtiyoriy)
@app.route('/favicon.ico')
def favicon():
    return send_from_directory("static", "favicon.ico")

# Muhim: Railway gunicorn orqali ishga tushiradi,
# shuning uchun bu joyda app.run() YO‘Q!
